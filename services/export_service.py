...
Handles exporting expense data to CSV and Excel formats.
"""
...
def test_expense_service():
    ...
    result = service.create_expense("2024-12-04", "Food", "50000", "Test expense")
    print(f"   Create result: {result['success']} - {result.get('message', result.get('error', ''))}")
    ...
    analysis = service.get_monthly_analysis(2024, 12)
